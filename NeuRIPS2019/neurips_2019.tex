...
\bibitem{allnewsdata} Mahudeswaran, D. (2018, November 2). FakeNewsNet. Retrieved from https://www.kaggle.com/mdepak/fakenewsnet#PolitiFact\_real\_news\_content.csv
\end{thebibliography}
\end{document}
